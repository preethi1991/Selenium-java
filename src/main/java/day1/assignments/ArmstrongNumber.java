...
public class ArmstrongNumber {
	...
	public static void main(String[] args) {
		...
		// Declare your input
		int num=153;
		System.out.println(" Check if armstrong or not");
		...
		while(original>0)
		{
			...
			System.out.println("remiinder" +remainder);
		...
		if (calculated==num)
		{
			System.out.println("Its is an Armstrong number" + calculated);
		}
		else
		{
			System.out.println("not an Armstrong number" + calculated);
